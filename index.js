...
client.on("voiceStateUpdate", (oldMember, newMember) => {
  ...
  if (
    ...
    let role = oldMember.guild.roles.cache.get(currentlyGrindingRole);
    oldMember.member.roles.add(role).catch(console.error);
  } else if (
    oldUserChannel === voiceChannelID2 &&
    newUserChannel !== voiceChannelID2
...
client.on("message", (message) => {
  ...
  if (
    ...
    message.content === `Sadeed` ||
    message.content === `sadeed` ||
    message.content === `ilmun` ||
    message.content === `Ilmun` ||
    message.content === "DetectiveBongHits"
  ) {
    ...
    message.content === "Jay" ||
    message.content === "jay" ||
    message.content === "Jayant" ||
    message.content === "jayant" ||
    message.content === "MemeSupremeJay"
  ) {
    ...
    message.content === "Noyan" ||
    message.content === "noyan" ||
    message.content === "Noyano"
  ) {
    ...
    message.content === `David` ||
    message.content === `david` ||
    message.content === "Cow" ||
    message.content === "KingCao" ||
    message.content === "DAVID" ||
    message.content === `cow`
  ) {
    ...
    message.content === "Andrew" ||
    message.content === "andrew" ||
    message.content === "Woody" ||
    message.content === "woody"
  ) {
    ...
    message.content === "Renzi" ||
    message.content === "renzi" ||
    message.content === "renz" ||
    message.content === "Renz"
  ) {
    message.channel.send(
    ...
    message.content === "Anthony" ||
    message.content === "anthony" ||
    message.content === "Tony" ||
    message.content === "tony"
  ) {
  ...
  //time to: statements (time to grind/wakeup/sleep)
    ...
    message.content === "time to grind" ||
    message.content === "grind time" ||
    message.content === "let's grind"
  ) {
    computerOptions = [
    ...
    message.content === "time to wake up" ||
    message.content === "get off your lazy ass" ||
    message.content === "get out of bed" ||
    message.content === "wake up"
  ) {
  ...
  //I need statements
    ...
    message.content === "I need some motivation" ||
    message.content === "motivation" ||
    message.content === "MOTIVATION"
  ) {
    computerOptions = [
  ...
  //common phrases
    ...
    message.content === "brb" ||
    message.content === "gonna go eat" ||
    message.content === `ima go eat` ||
    message.content === `done for the day`
  ) {
